...
typedef struct {
	...
	vec3_t		prevRefViewAngles;
	vec3_t		viewAnglesDelta;
	vec3_t		viewModelLagOffset = {0, 0, 0};
	qboolean	viewAnglesDeltaValid;
...
extern	vmCvar_t		cg_torsoYawMax;
extern	vmCvar_t		cg_torsoYawSnapSpeed;
extern	vmCvar_t		cg_atstYawMax;
extern	vmCvar_t		cg_atstYawSnapSpeed;
